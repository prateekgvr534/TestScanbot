...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TestBlankApp.Android.dll" comes first in this list. */
		"TestBlankApp.Android.dll",
		"Barcode.Scanner.SDK.dll",
		"Barcode.Scanner.SDK.UI.dll",
		"FormsViewGroup.dll",
		"Naxam.ReactiveStreams.Droid.dll",
		"Naxam.RxAndroid.Droid.dll",
		"Naxam.RxJava2.Droid.dll",
		"Scanbot.SDK.Dependencies.dll",
		"Scanbot.Xamarin.JetBrains.Java.Annotations.dll",
		"Scanbot.Xamarin.Kotlin.StdLib.Common.dll",
		"Scanbot.Xamarin.Kotlin.StdLib.dll",
		"Scanbot.Xamarin.Kotlin.StdLib.Jdk7.dll",
		"ScanbotBarcodeSDK.Forms.dll",
		"ScanbotBarcodeSDK.Forms.Droid.dll",
		"ScanbotBarcodeSDK.Xamarin.dll",
		"ScanbotBarcodeSDK.Xamarin.Droid.dll",
		"SDK.Barcode.dll",
		"SDK.Base.dll",
		"SDK.Core.Barcode.dll",
		"SDK.Core.Barcode.Native.dll",
		"SDK.Core.Sap.dll",
		"SDK.UI.Barcode.dll",
		"SDK.UI.Base.dll",
		"TestBlankApp.dll",
